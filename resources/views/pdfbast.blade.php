...
<body>
    ...
    <table class="worklist">
        ...
        <tr>
            ...
            <td style="width: 380px">&nbsp;&nbsp;{{ $data->itemname1 }}</td>
            <td style="width: 100px; text-align: right">{{ $data->qtyitem1 }}&nbsp;&nbsp;</td>
            <td style="width: 100px; text-align: right">{{ $data->unititem1 }}&nbsp;&nbsp;</td>
        </tr>
        <?php if (!is_null($data->itemname2)): ?>
        <tr>
            <td style="width: 20px; text-align: center">2.</td>
            <td style="width: 380px">&nbsp;&nbsp;{{ $data->itemname2 }}</td>
            <td style="width: 100px; text-align: right">{{ $data->qtyitem2 }}&nbsp;&nbsp;</td>
            <td style="width: 100px; text-align: right">{{ $data->unititem2 }}&nbsp;&nbsp;</td>
        </tr>
        <?php endif; ?>
        <?php if (!is_null($data->itemname3)): ?>
        <tr>
            <td style="width: 20px; text-align: center">3.</td>
            <td style="width: 380px">&nbsp;&nbsp;{{ $data->itemname3 }}</td>
            <td style="width: 100px; text-align: right">{{ $data->qtyitem3 }}&nbsp;&nbsp;</td>
            <td style="width: 100px; text-align: right">{{ $data->unititem3 }}&nbsp;&nbsp;</td>
        </tr>
        <?php endif; ?>
        <?php if (!is_null($data->itemname4)): ?>
        <tr>
            <td style="width: 20px; text-align: center">4.</td>
            <td style="width: 380px">&nbsp;&nbsp;{{ $data->itemname4 }}</td>
            <td style="width: 100px; text-align: right">{{ $data->qtyitem4 }}&nbsp;&nbsp;</td>
            <td style="width: 100px; text-align: right">{{ $data->unititem4 }}&nbsp;&nbsp;</td>
        </tr>
        <?php endif; ?>
        <?php if (!is_null($data->itemname5)): ?>
        <tr>
            <td style="width: 20px; text-align: center">5.</td>
            <td style="width: 380px">&nbsp;&nbsp;{{ $data->itemname5 }}</td>
            <td style="width: 100px; text-align: right">{{ $data->qtyitem5 }}&nbsp;&nbsp;</td>
            <td style="width: 100px; text-align: right">{{ $data->unititem5 }}&nbsp;&nbsp;</td>
        </tr>
        <?php endif; ?>
    </table>
    ...
    <table class="tandatangan">
        ...
        <tr>
            <td class="ttd"></td>
            @if ($data->status >= '4')
                <td class="ttd"><img src="{{ public_path($signaturepurch) }}" alt="TTD Abiyyu"
                        width="100px"></td>
            @else
                <td></td>
            @endif
