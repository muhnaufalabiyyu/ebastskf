...
<body>
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #001524;">
        <div class="container">
            <a class="navbar-brand" href=" {{ url('/') }}" style="color:#0068B0">Purchasing <span
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('approvalspr') }}"
                            class="nav-link {{ request()->routeIs('approvalspr') ? 'active' : '' }}">Approval SPR</a>
                    </li>
                    @elseif (Auth::user()->acting == 3)
                    <li class="nav-item">
                        <a href="{{ route('createspr') }}"
                            class="nav-link {{ request()->routeIs('createspr') ? 'active' : '' }}">Create SPR</a>
                    </li>
                @else
                    <a class="nav-link {{ request()->routeIs('createbast') ? 'active' : '' }}" aria-current="page"
                        href=" {{ route('createbast') }}">Create BAST</a>
                    @endif
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('historyspr') ? 'active' : '' }}"
                            href="{{ route('historyspr') }}">History SPR</a>
                    </li>
                </ul>
