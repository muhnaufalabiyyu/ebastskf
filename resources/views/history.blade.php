...
<div class="container mt-3">
    ...
    <div class="poready border-top border-4 mb-2 p-4">
        <div class="tbContainer">
            <table class="table table-bordered table-striped text-center nowrap" id="tbHistory" style="font-size: 14px">
                <thead>
                    <th>No.</th>
                    <th>ID Supplier</th>
                    <th>Supplier</th>
                ...
                <tbody>
                    @foreach ($bast as $row)
                        <tr>
                            ...
                            <td>{{ $row->pono }}</td>
                            <td>{{ $row->offerno }}</td>
                            <td class="td-max">{{ $row->workdesc }}</td>
                            <td>
                                @if ($row->status == '1' || $row->status == '0')
                                    ...
                                    <marquee behavior="sliding" direction="left" scrolldelay="200" style="font-size:0.8rem;">
                                        Waiting approval by EHS</marquee>
                                @elseif ($row->status == '2')
                                    <div class="progress">
                                        <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="0"
                                    ...
                                    <marquee behavior="sliding" direction="left" scrolldelay="200" style="font-size:0.8rem;">
                                        Waiting approval by {{ $row->to_user }}</marquee>
                                @elseif ($row->status == '3')
                                    <div class="progress">
                                        <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="0"
                                    ...
                                    <marquee behavior="sliding" direction="left" scrolldelay="200" style="font-size:0.8rem;">
                                        Waiting approval by Purchasing</marquee>
                                @elseif ($row->status == '4')
                                    <div class="progress">
                                        <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="0"
                                    ...
                                    <marquee behavior="sliding" direction="left" scrolldelay="200" style="font-size:0.8rem;">
                                        Waiting RR from Warehouse</marquee>
                                @else
